# AudioPlayer To CustomDiscs v1.1.2
### For Paper and Folia
### 1.21.11

[![GitHub Total Downloads](https://img.shields.io/github/downloads/Athar42/ap2cd/total?style=plastic&label=GitHub%20Downloads&color=success "Click here to download the plugin")](https://modrinth.com/plugin/audioplayer-to-customdiscs) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [![Modrinth Downloads](https://img.shields.io/modrinth/dt/audioplayer-to-customdiscs?style=plastic&label=Modrinth%20Downloads&color=success "Click here to download the plugin")](https://modrinth.com/plugin/audioplayer-to-customdiscs)
...
|--------------------------------------------|-----------------|----------------------------|-------------------------------------------------------------------------------|
| **1.21.7-9, 1.21.8**<br>**1.21.8**         | Paper<br>Folia  | 1.0.0-1.1.2<br>1.0.0-1.1.2 | [1.1.2](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.1.2) |
| **1.21.9, 1.21.10**<br>**1.21.9, 1.21.10** | Paper<br>Folia  | 1.0.0-1.1.2<br>1.0.0-1.1.2 | [1.1.2](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.1.2) |
| **1.21.11**<br>**1.21.11**                 | Paper<br>Folia  | 1.1.1<br>1.1.2             | [1.1.2](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.1.2) |
