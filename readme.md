# AudioPlayer To CustomDiscs v1.2.4
...
**Since version 1.1.5, [PacketEvents](https://modrinth.com/plugin/packetevents) (v2.12.1+) is required.**\
...
|--------|----------|-------|
| [PacketEvents](https://modrinth.com/plugin/packetevents) | ✅ Required | Since v1.1.5 — v2.12.1+ required |
...
# Operators are notified on join when an update is available.
...
|----------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| **1.21.7-9, 1.21.8**       | 1.0.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) | 1.0.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) |
| **1.21.9, 1.21.10**        | 1.0.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) | 1.0.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) |
| **1.21.11**                | 1.1.1 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) | 1.1.1 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4) |
| **26.1, 26.1.1, 26.1.2**   | 1.2.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         | 1.2.0 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         |
| **26.2**   | 1.2.1 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         | 1.2.1 - [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         |
| **26.3**   | [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         | [1.2.4](https://modrinth.com/plugin/audioplayer-to-customdiscs/version/1.2.4)         |
...
- This plugin may **(or may not)** work with earlier versions of PaperMC/Folia.
  - While this plugin is marked as compatible with Paper's forks, no extensive tests have been made on them. Report any issues on our Discord !
